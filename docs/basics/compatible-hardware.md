...
Kano Pixel Kit (Retail) | ESP32 | ESP-WROOM32 based programmable display for children. Uses GPIO 4 for Neopixels. Supports Wi-Fi, onboard buttons, anolog dial, and microphone.
